...
public interface Consts {
  ...
  // Schriftarten
  public static final TrueTypeFont FONT_15 =
      new TrueTypeFont(new Font("Courier New", Font.BOLD, 15), false);
  public static final TrueTypeFont FONT_20 =
      new TrueTypeFont(new Font("Courier New", Font.BOLD, 20), false);
  public static final TrueTypeFont FONT_30 =
      new TrueTypeFont(new Font("Courier New", Font.BOLD, 30), false);
  public static final TrueTypeFont FONT_15_GAMETOKEN =
      new TrueTypeFont(new Font("Courier New", Font.BOLD, 15), false);
