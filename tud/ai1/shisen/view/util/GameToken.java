...
public class GameToken extends Entity {
   ...
   * 
   * @throws SlickException Wirft eine SlickException, wenn eine Ausnahem passiert.
   */
  public GameToken(String entityID, Vector2f pos, IToken token, IGrid grid, int size)
