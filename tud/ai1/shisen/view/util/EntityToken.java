...
/**
 * Stellt die Entitaet Token fuer den View dar. Spiellogikdaten ueber den Token sind
 * im model in Klasse Token gespeichert.
 * 
...
public class EntityToken extends Entity {
   ...
   */
  public EntityToken(String entityID, IToken token, Vector2f pos, float scale)
  ...
  public void update(GameContainer gc, StateBasedGame sb, int delta) {
    ...
    switch (token.getTokenState()) {
       ...
       * if (displayWrongSelection)
       * break;
       * // setze token state nach bestimmter Zeit zuruek
       * Event wrongEvent = new TimedEvent("wrongEvent", Consts.DISPLAY_WRONG_TIME);
       * wrongEvent.addAction(new Action() {
       * 
       * @Override
       * public void update(GameContainer gc, StateBasedGame sb, int delta, Component event) {
       ...
       * }
       * });
       * this.addComponent(wrongEvent);
       * displayWrongSelection = true;
       * break;
       */
    }
  }
