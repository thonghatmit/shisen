...
public class GameplayState extends BasicGameState {
   ...
   * 
   * @throws SlickException Wirft eine SlickException, wenn bei der Spielerstellung ein Fehler
   *         auftritt.
   */
  @Override
  public void init(GameContainer container, StateBasedGame game) throws SlickException {
      ...
      public void update(GameContainer gc, StateBasedGame sb, int delta, Component event) {
        try {
          Desktop.getDesktop().browse(
              new URL("https://moodle.informatik.tu-darmstadt.de/mod/assign/view.php?id=17995")
                  .toURI());
        } catch (Exception e) {
          e.printStackTrace();
        }
    ...
    String[] buttonLabels = new String[] {"Back to Main Menu", "Surrender", "Moodle", "Hint",
        "Solve Pair", "Find Partner"};
   ...
   * @param game StateBasedGame
   * 
   * @throws SlickException Wirft eine SlickException, wenn beim Wechseln in den GameState ein
   *         Fehler auftritt.
   */
  @Override
   ...
   * @param game StateBasedGame
   * 
   * @throws SlickException Wirft eine Slickexception beim Updaten des EntityManagers, wenn ein
   *         Fehler auftritt.
   */
  @Override
   ...
   * @param g Graphics
   * 
   * @throws SlickException Wirft eine SlickException, wenn beim Rendern ein Fehler auftritt.
   */
  @Override
  public void render(GameContainer container, StateBasedGame game, Graphics g)
    ...
    g.drawString(String.format("Time: %02d:%02d",
        Math.round((System.currentTimeMillis() - startTime) / 60000),
  ...
  public Vector2f grid2Pos(int x, int y) {
    return new Vector2f(x * (imgSize + offset) + startPos.getX(),
        y * (imgSize + offset) + startPos.getY());
  }

  /**
   * Erzeugt das Spielfeld.
   * 
   * @throws SlickException Wirft eine SlickException, wenn beim Erzeugen des Spielfelds ein Fehler
   *         auftritt.
   */
   ...
   * @param game StateBasedGame
   * 
   * @throws SlickException Wirft eine SlickException, wenn beim Verlassen des GameStates ein Fehler
   *         auftritt.
   */
  @Override
  public void leave(GameContainer container, StateBasedGame game) throws SlickException {
    if (grid != null && (grid.getScore() > 0)) {
      ...
      HighscoreState.highscore.addEntry(
          new HighscoreEntry(date.withSecond(0), score, (System.currentTimeMillis() - startTime)));
